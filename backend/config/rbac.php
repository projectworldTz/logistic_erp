...
return [
    ...
    'default_role_permissions' => [
        ...
        'Company Owner' => ['core.*', 'crm.*', 'clearing.*', 'freight.*', 'containers.*', 'warehouse.*', 'fleet.*', 'finance.*', 'accounting.*', 'documents.*', 'reports.*', 'quotations.*', 'shipments.*', 'analytics.*', 'demurrage.*', 'expenses.*', 'workflows.*', 'hr.*'],
        'Company Admin' => ['core.*', 'crm.*', 'clearing.*', 'freight.*', 'containers.*', 'warehouse.*', 'fleet.*', 'finance.*', 'accounting.*', 'documents.*', 'reports.*', 'quotations.*', 'shipments.*', 'analytics.*', 'demurrage.*', 'expenses.*', 'workflows.*', 'hr.*'],
        'Branch Manager' => ['core.dashboard.view', 'core.branches.view', 'core.users.view', 'hr.*'],
        'Operations Manager' => ['core.dashboard.view', 'core.branches.view', 'clearing.files.view', 'freight.bookings.view', 'containers.items.view', 'warehouse.items.view', 'fleet.vehicles.view', 'finance.invoices.view', 'accounting.accounts.view', 'accounting.journal.view', 'documents.files.view', 'reports.view', 'quotations.items.view', 'shipments.*', 'analytics.view', 'demurrage.charges.view', 'demurrage.charges.manage', 'expenses.items.view', 'expenses.items.manage'],
        'Clearing Officer' => ['core.dashboard.view', 'clearing.files.view', 'clearing.files.manage', 'containers.items.view', 'containers.items.manage', 'shipments.items.view', 'demurrage.charges.view', 'demurrage.charges.manage', 'expenses.items.view', 'expenses.items.manage'],
        ...
        'Warehouse Manager' => ['core.dashboard.view', 'containers.items.view', 'containers.items.manage', 'warehouse.items.view', 'warehouse.items.manage', 'demurrage.charges.view', 'demurrage.charges.manage', 'expenses.items.view', 'expenses.items.manage'],
        ...
        'Finance Manager' => ['core.dashboard.view', 'finance.invoices.view', 'finance.invoices.manage', 'accounting.*', 'reports.view', 'analytics.view', 'demurrage.*', 'expenses.*', 'workflows.*'],
        'Accountant' => ['core.dashboard.view', 'finance.invoices.view', 'finance.invoices.manage', 'accounting.accounts.view', 'accounting.accounts.manage', 'accounting.journal.view', 'accounting.journal.manage', 'expenses.items.view', 'expenses.items.manage'],
