...
return [
    ...
    'default_role_permissions' => [
        ...
        'HR Manager' => ['core.dashboard.view', 'core.users.view', 'hr.*'],
        'HR Officer' => [
            'core.dashboard.view',
            'hr.departments.view',
        ...
        'Finance Manager' => ['core.dashboard.view', 'finance.invoices.view', 'finance.invoices.manage', 'finance.exchange_rates.view', 'finance.exchange_rates.manage', 'accounting.*', 'reports.view', 'analytics.view', 'demurrage.*', 'detention.*', 'expenses.*', 'workflows.*', 'shipments.items.view', 'shipments.costs.view', 'hr.payroll_components.view', 'hr.statutory_rules.view', 'hr.payroll_settings.view', 'hr.payroll_settings.manage', 'hr.payroll_periods.view', 'hr.payroll_runs.view', 'hr.payroll_runs.approve', 'hr.loans.view', 'hr.loans.approve', 'hr.advances.view', 'hr.advances.approve', 'hr.payslips.view.all'],
