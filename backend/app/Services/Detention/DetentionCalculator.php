...
class DetentionCalculator
{
     ...
     * whole detention period every time.
     */
    public function calculate(Container $container, ?DetentionRateCard $rateCard = null, ?CarbonInterface $asOf = null, int $alreadyChargedDays = 0): array
    {
        ...
        $totalChargeableDays = max(0, $detentionDays - $freeDays);
     ...
     */
    private function applyTiers(DetentionRateCard $rateCard, int $fromDay, int $toDay): array
    {
        $amount = 0.0;
        $breakdown = [];
